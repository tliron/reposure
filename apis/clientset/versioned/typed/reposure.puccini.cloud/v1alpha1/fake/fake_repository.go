...
type FakeRepositories struct {
	Fake *FakeReposureV1alpha1
	ns   string
}

var repositoriesResource = schema.GroupVersionResource{Group: "reposure.puccini.cloud", Version: "v1alpha1", Resource: "repositories"}

var repositoriesKind = schema.GroupVersionKind{Group: "reposure.puccini.cloud", Version: "v1alpha1", Kind: "Repository"}
